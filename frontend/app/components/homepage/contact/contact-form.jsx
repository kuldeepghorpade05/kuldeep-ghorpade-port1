      ...
      <div className="from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37] overflow-hidden shadow-2xl">
        ...
        <div className="p-4 lg:p-8 font-mono">
          <div className="flex flex-row mb-6">
            ...
            <span className="text-white">./send-message.sh</span>
          </div>
          <p className="text-sm text-[#d3d8e8] mb-6">{"// If you have any questions or concerns, please don't hesitate to contact me. I am open to any work opportunities that align with my skills and interests."}</p>
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <label className="text-base text-[#16f2b3]">Your Name: </label>
              <input
            ...
            <div className="flex flex-col gap-2">
              <label className="text-base text-[#16f2b3]">Your Email: </label>
              <input
                className="bg-[#10172d] w-full border rounded-md border-[#353a52] focus:border-[#16f2b3] ring-0 outline-0 transition-all duration-300 px-3 py-2 text-white"
                type="email"
                maxLength="100"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-base text-[#16f2b3]">Your Message: </label>
              <textarea
                className="bg-[#10172d] w-full border rounded-md border-[#353a52] focus:border-[#16f2b3] ring-0 outline-0 transition-all duration-300 px-3 py-2 text-white"
                maxLength="500"
                name="message"
